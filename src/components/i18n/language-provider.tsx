...
const translations = {
  en: {
    ...
    rewardsSubtitle: "Compare product plans and buy items securely",
    ...
    rewardDetailsSubtitle: "Choose a plan, fill the required info, and buy your product",
    outOfStock: "Out of stock",
    remaining: "Remaining",
    makeSureInfoMatches: "Make sure your required info is filled correctly before continuing.",
    ...
    stepSendCode: "2. Send the code and payment screenshot",
    stepSendCodeHint: "Send the code along with a screenshot of the completed payment to the official Arcetis Instagram account so the team can process your order.",
    ...
    spendPointsForProduct: "Confirm your product order?",
    plan: "Plan",
    confirmSpendWarning: "This creates your order. If the team rejects it later, any points used will be refunded automatically.",
    noCancel: "No, cancel",
  ...
  ar: {
    ...
    rewardsSubtitle: "قارن بين الخطط واشترِ المنتجات بأمان",
    ...
    rewardDetailsSubtitle: "اختر الخطة، املأ المعلومات المطلوبة، واشترِ منتجك",
    outOfStock: "غير متوفر",
    remaining: "المتبقي",
    makeSureInfoMatches: "تأكد أن المعلومات المطلوبة كلها صحيحة ومناسبة قبل المتابعة.",
    ...
    stepSendCode: "2. أرسل الكود وصورة الدفع",
    stepSendCodeHint: "أرسل الكود مع صورة تثبت إتمام الدفع إلى حساب Arcetis الرسمي على إنستغرام ليتم معالجة طلبك بسرعة.",
    ...
    spendPointsForProduct: "تأكيد طلب المنتج؟",
    plan: "الخطة",
    confirmSpendWarning: "سيتم إنشاء طلبك الآن. إذا رفضه الفريق لاحقًا سيتم رد أي نقاط مستخدمة تلقائيًا.",
    noCancel: "لا، إلغاء",
