    ...
    () =>
      language === "ar"
        ...
        : {
            ...
            closeDtModal: "Close TND purchase details",
            buyWithDt: "Buy with TND",
            completeThroughInstagram: "Complete this purchase through Instagram",
            dtDescription:
              "To buy with TND, send us a message on Instagram with the product name, selected plan, and the info you already prepared.",
            price: "Price",
